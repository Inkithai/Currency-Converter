...
const TransferHistory = ({ modalVisible, closeModal, userId }) => {
  ...
  // Use useCallback to memoize fetchTransfers function
  ...
  }, [userId]); // Only recreate the function if userId changes
  ...
  }, [modalVisible, fetchTransfers]); // Add fetchTransfers to the dependency array
